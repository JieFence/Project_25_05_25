...
public class QuestIcon : MonoBehaviour
{
    ...
    public void SetState(QuestState questState, bool startPoint, bool finishPoint)
    {
        ...
        switch (questState)
        {
            ...
            case QuestState.FINISHED:
                Debug.Log("You hava complete the Quest!");
                break;
            default:
                Debug.LogWarning("Quest State not recongnized by switch statement for quest icon :" + questState);
                break;
